...
public class TAzureDlsGen2ConnectionPropertiesTest {

    TAzureDlsGen2ConnectionProperties props;

    @Before
    public void setUp() throws Exception {
        props = new TAzureDlsGen2ConnectionProperties("test");
    ...
    /**
     * Test method for
     * {@link TAzureDlsGen2ConnectionProperties#setupProperties()}.
     */
    @Test
    public final void testSetupProperties() {
        assertEquals(props.authenticationType.getValue(), AuthType.BASIC);
        Assert.assertEquals(props.protocol.getValue(), Protocol.HTTPS);
