...
import org.talend.components.azure.dlsgen2.AzureDlsGen2GenericBase;
...
public class AzureDlsGen2ConnectionWizardTest extends AzureDlsGen2GenericBase {
    ...
    public void testWizard() throws Throwable {
        ...
        ComponentWizard wiz = getComponentService()
                .getComponentWizard(AzureDlsGen2ConnectionWizardDefinition.COMPONENT_WIZARD_NAME, "nodeAzureDlsGen2");
        assertNotNull(wiz);
        ...
        TAzureDlsGen2ConnectionProperties connProps = (TAzureDlsGen2ConnectionProperties) connFormWizard
                .getProperties();
        connProps.setupProperties();

        Object image = getComponentService()
                .getWizardPngImage(AzureDlsGen2ConnectionWizardDefinition.COMPONENT_WIZARD_NAME,
                                   WizardImageType.TREE_ICON_16X16);
        assertNotNull(image);
        image = getComponentService().getWizardPngImage(AzureDlsGen2ConnectionWizardDefinition.COMPONENT_WIZARD_NAME,
        ...
        connProps = (TAzureDlsGen2ConnectionProperties) PropertiesTestUtils.checkAndValidate(getComponentService(),
