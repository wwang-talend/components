...
public class AzureStorageContainerDeleteRuntimeTest {
    ...
    private TAzureDlsGen2ContainerDeleteProperties properties;

    private AzureDlsGen2ContainerDeleteRuntime deleteContainer;
    ...
    @Before
    public void setup() {
        properties = new TAzureDlsGen2ContainerDeleteProperties(PROP_ + "DeleteContainer");
        ...
        this.deleteContainer = new AzureDlsGen2ContainerDeleteRuntime();
