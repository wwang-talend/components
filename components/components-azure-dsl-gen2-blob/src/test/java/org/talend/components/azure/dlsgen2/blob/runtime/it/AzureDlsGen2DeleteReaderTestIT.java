...
@Ignore
public class AzureDlsGen2DeleteReaderTestIT extends AzureDlsGen2BaseBlobTestIT {

    private String CONTAINER;

    public AzureDlsGen2DeleteReaderTestIT() {
    ...
    public void testBlobDelete() throws Exception {
        TAzureDlsGen2DeleteProperties props = new TAzureDlsGen2DeleteProperties("tests");
