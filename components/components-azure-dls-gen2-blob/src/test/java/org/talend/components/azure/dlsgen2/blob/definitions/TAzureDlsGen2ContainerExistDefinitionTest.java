...
public class TAzureDlsGen2ContainerExistDefinitionTest extends AzureDlsGen2ContainerDefinitionTest {

    @Override
    public void setUp() throws Exception {
        azureStorageContainerDefinition = new TAzureDlsGen2ContainerExistDefinition();
    }

    @Override
    public void testGetPropertiesClass() {
        assertEquals(TAzureDlsGen2ContainerExistProperties.class, azureStorageContainerDefinition.getPropertiesClass());
    }
