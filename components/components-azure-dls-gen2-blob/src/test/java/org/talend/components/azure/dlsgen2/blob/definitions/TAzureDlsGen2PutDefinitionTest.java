...
public class TAzureDlsGen2PutDefinitionTest extends AzureDlsGen2ContainerDefinitionTest {

    @Override
    public void setUp() throws Exception {
        azureStorageContainerDefinition = new TAzureDlsGen2PutDefinition();
    }

    @Override
    public void testGetPropertiesClass() {
        assertEquals(TAzureDlsGen2PutProperties.class, azureStorageContainerDefinition.getPropertiesClass());
    }
