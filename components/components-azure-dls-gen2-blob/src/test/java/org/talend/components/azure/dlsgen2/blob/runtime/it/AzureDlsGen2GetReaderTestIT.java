...
@Ignore
public class AzureDlsGen2GetReaderTestIT extends AzureDlsGen2BaseBlobTestIT {
    ...
    public AzureDlsGen2GetReaderTestIT() {
        super("get-" + getRandomTestUID());
        CONTAINER = getNamedThingForTest(TEST_CONTAINER_1);
        properties = new TAzureDlsGen2GetProperties("tests");
