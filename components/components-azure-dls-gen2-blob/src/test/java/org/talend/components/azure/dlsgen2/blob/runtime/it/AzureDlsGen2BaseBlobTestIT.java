...
public class AzureDlsGen2BaseBlobTestIT extends AzureDlsGen2BaseTestIT {

    public AzureDlsGen2BaseBlobTestIT(String testName) {
        super(testName);
        // sets paths
     ...
     */
    @SuppressWarnings("rawtypes")
    public Boolean doContainerCreate(String container, AccessControl access)
            throws Exception {
        TAzureDlsGen2ContainerCreateProperties properties = new TAzureDlsGen2ContainerCreateProperties("tests");
    ...
    public Boolean doContainerDelete(String container) throws Exception {
        TAzureDlsGen2ContainerDeleteProperties properties = new TAzureDlsGen2ContainerDeleteProperties("tests");
        setupConnectionProperties(properties);
        properties.container.setValue(container);
        BoundedReader reader = createBoundedReader(properties);
        return reader.start();
    ...
    public Boolean doContainerExist(String container) throws Exception {
        TAzureDlsGen2ContainerExistProperties properties = new TAzureDlsGen2ContainerExistProperties("tests");
        setupConnectionProperties(properties);
        properties.container.setValue(container);
        BoundedReader reader = createBoundedReader(properties);
        return reader.start();
    ...
    public BoundedReader createContainerListReader() throws Exception {
        TAzureDlsGen2ContainerListProperties properties = new TAzureDlsGen2ContainerListProperties("tests");
        setupConnectionProperties(properties);
    ...
    public void uploadTestBlobs(String container) throws Exception {
        ...
        TAzureDlsGen2PutProperties props = new TAzureDlsGen2PutProperties("tests");
