...
public class TAzureDlsGen2GetDefinitionTest extends AzureDlsGen2ContainerDefinitionTest {

    @Override
    public void setUp() throws Exception {
        azureStorageContainerDefinition = new TAzureDlsGen2GetDefinition();
    }

    @Override
    public void testGetPropertiesClass() {
        assertEquals(TAzureDlsGen2GetProperties.class, azureStorageContainerDefinition.getPropertiesClass());
    }
