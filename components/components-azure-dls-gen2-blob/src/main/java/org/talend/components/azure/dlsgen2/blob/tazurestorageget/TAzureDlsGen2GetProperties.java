...
public class TAzureDlsGen2GetProperties extends AzureDlsGen2BlobProperties implements SerializeSetVersion {
    ...
    public Property<Boolean> keepRemoteDirStructure = PropertyFactory.newBoolean("keepRemoteDirStructure")
            .setRequired(); //$NON-NLS-1$

    public RemoteBlobsGetTable remoteBlobsGet = new RemoteBlobsGetTable("remoteBlobsGet"); //$NON-NLS-1$

    public TAzureDlsGen2GetProperties(String name) {
        super(name);
    }
