 ...
 */
public class TAzureDlsGen2ConnectionProperties extends ComponentPropertiesImpl
    ...
    private static final I18nMessages i18nMessages = GlobalI18N.getI18nMessageProvider()
            .getI18nMessages(TAzureDlsGen2ConnectionProperties.class);
    //
    ...
    public ComponentReferenceProperties<TAzureDlsGen2ConnectionProperties> referencedComponent = new ComponentReferenceProperties<>(
            "referencedComponent", TAzureDlsGen2ConnectionDefinition.COMPONENT_NAME);

    public PresentationItem testConnection = new PresentationItem("testConnection", "Test connection");

    public List<NamedThing> BlobSchema = null;

    public TAzureDlsGen2ConnectionProperties(String name) {
        super(name);
    }
    ...
    public void refreshLayout(Form form) {
        ...
        boolean useOtherConnection = refComponentIdValue != null
                && refComponentIdValue.startsWith(TAzureDlsGen2ConnectionDefinition.COMPONENT_NAME);
        ...
        if (form.getName().equals(Form.MAIN) || form.getName().equals(FORM_WIZARD)) {
            ...
            form.getWidget(sharedAccessSignature.getName())
                    .setVisible(!useOtherConnection && isBasicAuthUsed && isSASAuthUsed);
        }
    }
    ...
    public ValidationResult validateTestConnection() throws Exception {
        try {
            ...
            ValidationResult vr = AzureDlsGen2SourceOrSink.validateConnection(this);
            ...
            if (useSharedAccessSignature.getValue()) {
                ...
                if (allowedBlob) {
                    BlobSchema = AzureDlsGen2SourceOrSink.getSchemaNames(null, this);
                }
            } else {
                BlobSchema = AzureDlsGen2SourceOrSink.getSchemaNames(null, this);
            }
    ...
    public TAzureDlsGen2ConnectionProperties getReferencedConnectionProperties() {
        TAzureDlsGen2ConnectionProperties refProps = referencedComponent.getReference();
        if (refProps != null) {
            return refProps;
        }
        return null;
    ...
    public TAzureDlsGen2ConnectionProperties setRepositoryLocation(String repositoryLocation) {
